...
public class MazeSolver {
    ...
    private void loadGrid() throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(
                MazeSolver.class.getClassLoader().getResourceAsStream("es/usj/day20/input.txt")))) {
            String line;
    ...
    private int findCheats(int baseDistance) {
        ...
        while (!queue.isEmpty()) {
            ...
            if (curr.cheatStart == null) {
                if (grid[pos.row][pos.col] != '#') {
                    queue.offer(new State(curr.dist, pos, null, 2, pos));
                }
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(solver.findCheats(baseDistance));
    }
}